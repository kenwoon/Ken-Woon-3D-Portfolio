...
import { Environment, OrbitControls, Preload, Sky, useAnimations, useFBX, useGLTF } from "@react-three/drei";
import { useControls } from "leva";
import * as THREE from "three";

import CanvasLoader from "../Loader";

const Computers = ({ isMobile, animation }) => {
  const group = useRef();
  ...
  return (
    ...
    >
      <Suspense fallback={<CanvasLoader />}>
        ...
        <Computers isMobile={isMobile} animation={"Typing"}/>
      </Suspense>
